...
export function Pagination({pagination}){
    ...
    <span className="text-sm text-gray-700 dark:text-gray-400">
        Mostrando <span className="font-semibold text-gray-900 dark:text-white">1</span> de <span className="font-semibold text-gray-900 dark:text-white"></span><span className="font-semibold text-gray-900 dark:text-white">{total}</span> Videojuegos
    </span>
